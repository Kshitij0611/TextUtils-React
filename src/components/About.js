    ...
    <div className="container" style = {{color: props.mode === 'dark' ? 'white' : '#042743'}} >
      ...
      <div className="accordion" id="accordionExample">
        ...
        <div className="accordion-item" style={myStyle}>
          ...
          >
            <div className="accordion-body" style={myStyle}>
             TextUtils is free character counter tool that provides instant character count & word
        ...
        <div className="accordion-item" style={myStyle}>
          ...
          >
            <div className="accordion-body" style={myStyle}>
              ...
              Safari, Opera. It suits to count character in facebook, blog, books, excel document, pdf document
              essays etc.
            </div>
          </div>
        </div>
